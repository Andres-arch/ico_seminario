        ...
        <div class="row">
          <div class="span12">
            ...
            <div class="row">
              ...
              <div class="span3">
                <h5>Decide tu paquete y obten los mejores servicios</h5>
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  <div class="heading">
                    <h4 >Standard</h4>
                    <span>Compra y venta de antiguedades.
                      Se ofrecen los servicios necesarios para facilitar
                  ...
                  <div class="desc">
                    <ul>
                      <li> gratis</li>
                      <li>Vendedor decide un precio para su producto</li>
                      <li>Precio extra sobre el producto final de un 5%</li>
                      <li>Perfilamiento para acercar compradores a productos que 
                          puedan estar interesados.
                      </li>
                    </ul>
                  </div>
                  <div class="action">
                    <a href="Suscribirse.php" class="btn btn-inverse">Sign Up</a>
                  </div>
                </div>
              </div>
              ...
              <div class="span3">
                <div class="pricing-box-plain">
                  ...
                  <div class="desc">
                    <ul>
                      <li>Sumado a los servicios anteriores se suma un cotejo del precio del producto para estimar su valor real
                        respuesta en maximo siete días habiles
                      </li>
                      <li>precio: $120 al mes</li>
