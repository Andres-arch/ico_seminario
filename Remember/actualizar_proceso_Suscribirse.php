...
if($Nombre=="" || $Apellido=="" || $Email=="" || $Telefono=="" || $Tipo_de_Usuario=="" || $Tipo_de_Suscripcion=="" || $Contrasena==""){
    ...
    $sql = "UPDATE $tabla_db SET Nombre='$Nombre', Apellido='$Apellido', Telefono='$Telefono', Tipo_Usuario='$Tipo_de_Usuario', Tipo_suscripcion='$Tipo_de_Suscripcion', Pass='$Contrasena'  WHERE mail= '$Email'";
